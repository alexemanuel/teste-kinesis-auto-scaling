...
locals {
  ...
  kinesis_stream_shard_count      = 2 # Starting shard count, autoscaling will right-size this
}
...
# resource aws_kinesis_stream autoscaling_kinesis_stream2 {
#   name             = "teste-kinesis" 
#   shard_count      = local.kinesis_stream_shard_count
#   retention_period = local.kinesis_stream_retention_period
...
# module "kinesis_stream_scaling_alarms" {
#   source                         = "./modules/scaling_alarms"
#   kinesis_stream                 = aws_kinesis_stream.autoscaling_kinesis_stream
...
#   metrics_evaluation_period_secs = local.kinesis_period_secs
# }

# module "kinesis_stream_scaling_alarms2" {
#   source                         = "./modules/scaling_alarms"
#   kinesis_stream                 = aws_kinesis_stream.autoscaling_kinesis_stream2
#   scale_up_evaluation_period     = local.kinesis_scale_up_evaluation_period
#   scale_up_datapoints_required   = local.kinesis_scale_up_datapoints_required
#   scale_up_threshold             = local.kinesis_scale_up_threshold
#   scale_down_evaluation_period   = local.kinesis_scale_down_evaluation_period
